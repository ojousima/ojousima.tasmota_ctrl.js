...
class TemperatureControl {
  ...
  constructor(name:string) {
    ...
    this.roomName = name;
    this.ctrlTimer = setInterval(function(ctrl:TemperatureControl){
      const target = new TemperatureTarget(ctrl.profile.targetNow, ctrl.temperatureHysteresis);
  ...
  printTarget(target: TemperatureTarget):void {
    console.log("Heating up " + this.roomName + " to " + target.targetTemp + " degrees");
  }
}
